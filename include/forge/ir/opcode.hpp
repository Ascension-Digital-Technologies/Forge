...
[[nodiscard]] constexpr std::string_view opcode_name(Opcode opcode) noexcept {
    ...
    case Opcode::divide_signed: return "div.s";
    case Opcode::divide_unsigned: return "div.u";
    case Opcode::remainder_signed: return "rem.s";
    case Opcode::remainder_unsigned: return "rem.u";
    ...
    case Opcode::shift_right_signed: return "shr.s";
    case Opcode::shift_right_unsigned: return "shr.u";
