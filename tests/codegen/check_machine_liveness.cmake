...
endforeach()
if(machine-dead-instructions-eliminated LESS 3)
  message(FATAL_ERROR "expected at least three globally dead machine instructions: ${output}")
endif()
if(machine-dead-comparisons-eliminated LESS 1)
  message(FATAL_ERROR "expected one dead comparison to be removed: ${output}")
endif()
if(machine-liveness-iterations LESS 2)
  message(FATAL_ERROR "expected fixed-point liveness iteration: ${output}")
endif()
