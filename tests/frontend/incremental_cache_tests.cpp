...
int main() {
    ...
    const auto plan = forge::ir::build_incremental_build_plan(previous, current, "dash", "-O2;x86_64");
    ...
    const auto metadata_plan = forge::ir::build_incremental_build_plan(
        previous, forge::ir::build_incremental_snapshot(metadata_module), "dash", "-O2;x86_64");
