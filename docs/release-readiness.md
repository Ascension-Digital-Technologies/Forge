...
Forge 2.0.12, released August 12, 2026, is a stable release of the documented compiler core, frontend SDK, ABI-classification API, native library workflows, and x86-64 scalar/pointer backend.
